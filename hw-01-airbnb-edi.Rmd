...
"id" the ID number of the listing, "price", price for one night stay, "neighborhood", where the listing is located, "accommodates" how many people can fit or the listing can accommodate for,"bathrooms" number of bathrooms, "bedrooms" number of bedrooms, "beds" how many beds are in the listing. Then Review scores rating, which is average rating of property, "number of reviews" which is how many reviews the listing has and then the URL. 
...
I chose this layout because it is organized and easy to observe for each neighborhood.  


```{r edibnb_price-hist, eval= TRUE}
...
``` {r edibnb_boxplot, eval= TRUE}
ggplot(edibnb, aes(x = reorder(neighbourhood, review_scores_rating, median, na.rm = TRUE), 
                    y = review_scores_rating, fill = neighbourhood)) +
